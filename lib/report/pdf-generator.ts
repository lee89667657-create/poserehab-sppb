...
export async function generatePdfReport(data: ReportData): Promise<Blob> {
  ...
  addText(
    isKo
      ? 'PosFit에서 생성됨 • 이 리포트는 참고용이며 의료 조언을 대체하지 않습니다.'
      : 'Generated by PosFit • This report is for reference only and does not replace medical advice.',
    pageWidth / 2,
    footerY,
